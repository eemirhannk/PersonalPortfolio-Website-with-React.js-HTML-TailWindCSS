  ...
  return (
    <section className='min-h-screen pt-96 px-[9%] pb-8 max-[991px]:pt-40 max-[991px]:px-[3%] max-[991px]:pb-8' id='skills'>
        ...
        <div className="flex justify-center items-center gap-8 ">
            ...
            <div className="flex-2 max-h-fit bg-grey pt-12 px-16 pb-16 text-center rounded-[2rem] border-[.2rem] border-solid border-grey ease-linear duration-[.4s] hover:border-blue hover:scale-[1.02]">
